MapSongBanks::
	...
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; KINDLE_ROAD
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_EMBER_1F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_EMBER_2F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_EMBER_3F
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; UNUSED_MAP_70
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; LANCES_ROOM
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; WILD_MEADOW
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; WATER_PATH
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; RUIN_VALLEY
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TEMPLE
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; BILLS_HIDEOUT
